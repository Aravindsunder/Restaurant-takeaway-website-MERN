...
function AdminCalender() {
        ...
        const initialDaysData = [
          {
            ...
            openTime: data.opening_hours.sunday.length > 0
              ? `${Math.min(...data.opening_hours.sunday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.sunday.length > 0
              ? `${Math.max(...data.opening_hours.sunday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
          {
            ...
            openTime: data.opening_hours.monday.length > 0
              ? `${Math.min(...data.opening_hours.monday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.monday.length > 0
              ? `${Math.max(...data.opening_hours.monday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
          {
            ...
            openTime: data.opening_hours.tuesday.length > 0
              ? `${Math.min(...data.opening_hours.tuesday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.tuesday.length > 0
              ? `${Math.max(...data.opening_hours.tuesday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
          {
            ...
            openTime: data.opening_hours.wednesday.length > 0
              ? `${Math.min(...data.opening_hours.wednesday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.wednesday.length > 0
              ? `${Math.max(...data.opening_hours.wednesday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
          {
            ...
            openTime: data.opening_hours.thursday.length > 0
              ? `${Math.min(...data.opening_hours.thursday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.thursday.length > 0
              ? `${Math.max(...data.opening_hours.thursday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
          {
            ...
            openTime: data.opening_hours.friday.length > 0
              ? `${Math.min(...data.opening_hours.friday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.friday.length > 0
              ? `${Math.max(...data.opening_hours.friday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
          {
            ...
            openTime: data.opening_hours.saturday.length > 0
              ? `${Math.min(...data.opening_hours.saturday).toString().padStart(2, '0')}:00`
              : "09:00",
            closeTime: data.opening_hours.saturday.length > 0
              ? `${Math.max(...data.opening_hours.saturday).toString().padStart(2, '0')}:00`
              : "18:00",
            deliverySlots: {},
          },
        ]; 
  ...
  const submitSlots = async () => {
    ...
    try {
      const response = await fetch("http://localhost:5000/restaurant/update", {
        method: "PUT",
        headers: {
  ...
  return (
    <div className={`${styles.container} text-center`}>
      ...
      <Button variant="primary" onClick={submitSlots} className={styles.btnSubmit}>
        Submit Changes
      </Button>
